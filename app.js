...
app.put("/people/:index", (req, res) => {
     ...
     res.json(people[index]); // responde con el elemento actualizado
...
app.delete("/people/:index", (req, res) => {
  ...
  let index = req.params.index;
  delete people[index]; // metodo delete para eliminar un elemento
  res.json({ message: "Elemento eliminado" }); // envia como respuesta el mensaje en formato JSON
